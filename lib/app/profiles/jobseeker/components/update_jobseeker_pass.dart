...
class UpdateJobseekerPass extends StatelessWidget {
  const UpdateJobseekerPass(
      {super.key, required this.profileController, required this.jobseeker});

  final JobseekerProfileController profileController;
